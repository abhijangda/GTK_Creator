...
ToolBox::ToolBox()
    : Gtk::VBox(false,2),expander_windows("Windows"),table_windows(3,1), cmdWindow(), cmdOffscreenWindow(),
      ...
      imgcmdWindow("./icons/gtk_window.png"),imgcmdOffscreenWindow("./icons/gtk_offscreenwindow.png"),
      imgcmdVBox("./icons/gtk_vbox.png"), imgcmdHBox("./icons/gtk_hbox.png"), imgcmdTable("./icons/gtk_table.png"), imgcmdFixed("./icons/gtk_fixed.png"),  imgcmdScrolledWindow("./icons/gtk_scrollwin.png"),
      imgcmdToolBar("./icons/gtk_toolbar.png"),   imgcmdNotebook("./icons/gtk_notebook.png"),imgcmdFrame("./icons/gtk_frame.png"),imgcmdEventBox("./icons/gtk_eventbox.png"), 
    imgcmdExpander("./icons/gtk_expander.png"),imgcmdMenuBar("./icons/gtk_menubar.png"), 
     imgcmdButton("./icons/gtk_button.png"), imgcmdTextview("./icons/gtk_textview.png"), imgcmdEntry("./icons/gtk_entry.png"), imgcmdLabel("./icons/gtk_label.png"),
     imgcmdToggleButton("./icons/gtk_togglebutton.png"), imgcmdStatusBar("./icons/gtk_statusbar.png"), imgcmdComboBox("./icons/gtk_combobox.png"), imgcmdComboBoxText("./icons/gtk_comboboxtext.png"), 
    imgcmdCheckButton("./icons/gtk_checkbutton.png"),imgcmdRadioButton("./icons/gtk_radiobutton.png"),imgcmdVScale("./icons/gtk_vscale.png"), imgcmdSpinButton("./icons/gtk_spinbutton.png"), 
    imgcmdFileChooserButton("./icons/gtk_filechooserbutton.png"), imgcmdColorChooserButton("./icons/gtk_colorchooserbutton.png"), imgcmdFontButton("./icons/gtk_fontbutton.png"),
     imgcmdHScale("./icons/gtk_hscale.png"),imgcmdScrollbar("./icons/gtk_hscrollbar.png"),imgcmdProgressBar("./icons/gtk_progressbar.png"),
      imgcmdSpinner("./icons/gtk_spinner.png"), imgcmdTreeView("./icons/gtk_treeview.png")
{
